...
$(document).ready(function(){
    ...
    $(window).scroll(function(){
        ...
        let w_width = $(window).width();
        if(w_width > 940 && w_s_top >= oprod_top - 100) {
        ...
        else if (w_width <= 940 && w_s_top >= oprod_top - 150) {
            console.log(w_width)
        ...
        setInterval(function(){
            if(w_width > 940 && w_s_top >= b_o_top - 100) {
            ...
            else if (w_width <= 940 && w_s_top >= b_o_top - 300) {
                $('.b_item_box').eq(i_b_no % i_b_length).css({
                    transform: 'translateY(0)',
                    transition: 'all 0.5s',
                    opacity: 1
